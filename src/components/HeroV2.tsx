      ...
      <section className="relative z-30 mx-auto flex min-h-screen w-full max-w-[1600px] translate-y-8 flex-col justify-between px-4 pb-8 pt-4 transition-transform duration-300 sm:px-6 md:px-10 lg:px-14 min-[2560px]:-translate-y-16">
        ...
        <div className="relative z-30 mt-3 grid flex-1 grid-cols-1 items-end gap-6 text-center sm:mt-6 lg:mt-44 lg:grid-cols-12 lg:gap-6 lg:text-left xl:mt-64 xl:gap-8 min-[2560px]:z-[60]">
          <div className="pointer-events-auto w-fit max-w-full space-y-4 bg-[linear-gradient(to_top,rgba(4,7,10,0.92),transparent_78%)] p-3 text-shadow-[0_2px_10px_rgba(0,0,0,0.8)] sm:space-y-5 sm:p-5 lg:col-span-6 lg:-mx-5 lg:px-5 lg:py-4">
            ...
            <p className="mx-auto max-w-lg font-mono text-sm italic leading-relaxed tracking-wide text-slate-200 drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)] sm:text-base lg:mx-0">Turning ideas into immersive, high-performance web experiences with modern tech and a creative mindset.</p>
