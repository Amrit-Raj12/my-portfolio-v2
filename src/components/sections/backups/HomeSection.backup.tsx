    ...
    <div className="w-full h-screen relative overflow-hidden" style={{ background: "#06090D" }}>
      ...
      <div className="flex flex-col md:flex-row w-full h-full">
        ...
        >
          ...
          <div className="absolute inset-0 opacity-[0.04] pointer-events-none" style={{ zIndex: 2, backgroundImage: "linear-gradient(var(--neon-yellow) 1px, transparent 1px), linear-gradient(90deg, var(--neon-yellow) 1px, transparent 1px)", backgroundSize: "40px 40px" }} />
          <div className="absolute inset-0 opacity-30 pointer-events-none" style={{ zIndex: 2, background: "radial-gradient(circle at 50% 50%, rgba(255,214,0,0.25) 0%, transparent 70%)" }} />
          ...
          <div className="absolute inset-0 flex items-center justify-center" style={{ zIndex: 5 }}>
            <div className="relative w-[300px] h-[300px] md:w-[600px] md:h-[600px] flex items-center justify-center">
              <div className="absolute inset-0 opacity-40 md:opacity-100" style={{ clipPath: "polygon(50% 10%, 0% 90%, 100% 90%)", border: "2px solid rgba(255,214,0,0.8)", background: "linear-gradient(180deg, rgba(255,214,0,0.15) 0%, transparent 100%)", filter: "drop-shadow(0 0 15px rgba(255,214,0,0.5))" }} />
          ...
          <div className="absolute bottom-10 md:bottom-20 left-6 right-6 md:left-auto md:right-16 flex flex-col gap-3" style={{ zIndex: 10 }}>
            <StatOverlayCard label="LOCATION" value="INDIA" icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>} />
            <StatOverlayCard label="EXPERIENCE" value="4+ YEARS" icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></svg>} />
          </div>
        </div>
      </div>
      ...
      >
        <div className="flex flex-col items-center gap-2">
          <span className="font-orbitron text-[0.6rem] tracking-[0.45em] text-[#FFD600]" style={{ writingMode: "vertical-rl", textOrientation: "mixed", textShadow: "0 0 10px rgba(255,214,0,0.7)" }}>
            SCROLL
          </span>
          <div className="w-[1px] h-10 bg-gradient-to-b from-[#FFD600] to-transparent" />
          <div className="w-5 h-9 rounded-full border border-[#FFD600]/70 flex justify-center pt-1 relative overflow-hidden" style={{ boxShadow: "0 0 12px rgba(255,214,0,0.35)" }}>
