...
const navItems: NavItem[] = [
  ...
  { id: "about", icon: <User size={20} />, label: "About", href: "/about-me" },
  { id: "projects", icon: <FolderKanban size={20} />, label: "Projects", href: "/projects" },
  { id: "skills", icon: <Cpu size={20} />, label: "Skills", href: "/skills" },
  { id: "achievements", icon: <Trophy size={20} />, label: "Achievements", href: "/achievements" },
...
export default function Sidebar({ activeId = "home" }: SidebarProps) {
  ...
  return (
    <nav
      ...
      style={{
        ...
        background:
          "linear-gradient(180deg, rgba(6,9,13,0.98) 0%, rgba(0,240,255,0.03) 100%)",
      }}
    >
      {/* ── Logo ─────────────────────────────── */}
        ...
        {navItems.map((item) => {
          ...
          return (
            <div key={item.id} className="relative group">
              ...
              {/* Tooltip */}
              <div
                className="absolute left-full ml-3 top-1/2 -translate-y-1/2 px-3 py-1.5 rounded text-xs font-medium whitespace-nowrap pointer-events-none transition-all duration-200 cyber-heading"
                style={{
                  fontSize: "0.65rem",
